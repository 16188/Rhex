...
- Fixed sealed auction administration and point privacy by allowing admins to view sealed bid amounts, changing auction bids to reserve points without changing displayed balances or leaderboards, adding back active auction reservations in user point displays until settlement, enforcing reserved points in later spending, and charging the winner only when the auction settles.
