...
function getLotteryConditionValueMode(conditionType: string): ConditionValueFieldMode {
  ...
  if (conditionType === "USER_POST_COUNT" || conditionType === "DAILY_POST_COUNT" || conditionType === "DAILY_COMMENT_COUNT" || conditionType === "DAILY_RECEIVED_LIKE_COUNT" || conditionType === "DAILY_INVITE_COUNT") {
    return "number"
  }
